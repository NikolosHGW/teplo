...
namespace Teplo
{
    class PumpAnimVM
    {
        ...
        public static void StartPmpR()
        {
            ...
            {
                MStart.Open(new Uri("C:/Users/Николос/source/repos/teplo/Teplo/Resources/Start.mp3", UriKind.RelativeOrAbsolute)); /*C:/Users/Николос/source/repos/teplo/Teplo/Resources/Start.mp3" */ //дома /*C:/Users/Nikolos/Desktop/Новая папка/Картинки для проекта/Запуск.mp3*/
                MStart.Play();
            ...
            {
                MStop.Open(new Uri("C:/Users/Николос/Downloads/Останов.mp3", UriKind.RelativeOrAbsolute)); //C:/Users/Николос/Downloads/Останов.mp3   дома C:/Users/Nikolos/Desktop/Новая папка/Картинки для проекта/Останов.mp3
                MStop.Play();
