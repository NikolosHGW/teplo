...
namespace Teplo
{
    class WaterVM
    {
        ...
        public static void Start()
        {
            ...
            if (GetButtons.ButtonsVC[9].IsState == true && GetButtons.ButtonsVC[7].IsState == false && GetButtons.ButtonsVC[8].IsState == false && GetButtons.ButtonsC[3].IsState == true && Lines[11].Opacity == 1 && PumpAnimVM.RotationPmpR == true)
            {
                Lines[17].Opacity = 0;
                Lines[16].Opacity = 0;
                Lines[15].Opacity = 0;
            }
            if (GetButtons.ButtonsVC[6].IsState == true && GetButtons.ButtonsVC[7].IsState == false && GetButtons.ButtonsVC[8].IsState == false && GetButtons.ButtonsC[3].IsState == true && Lines[11].Opacity == 1 && PumpAnimVM.RotationPmpR == true)
            {
                Lines[12].Opacity = 0;
                Lines[13].Opacity = 0;
                Lines[14].Opacity = 0;
            }
            if (GetButtons.ButtonsVC[2].IsState == true && GetButtons.ButtonsVC[0].IsState == true && GetButtons.ButtonsVC[9].IsState == true && GetButtons.ButtonsVC[6].IsState == true && GetButtons.ButtonsSmlC[2].IsState == true && Lines[11].Opacity == 1 && PumpAnimVM.RotationPmpR == true)
            {
                if (AnLines[18] != null)
                {
